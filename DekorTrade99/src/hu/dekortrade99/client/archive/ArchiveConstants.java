...
public class ArchiveConstants {
	...
	public static final String RENDELTCIKK_SZINKOD = "rendeltcikk_szinkod";
	public static final String RENDELTCIKK_EXPORTKARTON = "rendeltcikk_exportkarton";
	public static final String RENDELTCIKK_KISKARTON = "rendeltcikk_kiskarton";
	public static final String RENDELTCIKK_DARAB = "rendeltcikk_darab";
