...
public class ForgalomConstants {

	private static ForgalomLabels forgalomLabels = GWT
			.create(ForgalomLabels.class);
	...
	public static LinkedHashMap<String, String> getMertekegyseg() {
		...
		if (mertekegyseg == null) {
			...
			mertekegyseg.put("DB", forgalomLabels.mertekegyseg_darab());
			mertekegyseg.put("SET", forgalomLabels.mertekegyseg_egyseg());
		}
		return mertekegyseg;
	}

	public static final String ELADAS_CEDULA = "eladas_cedula";
	public static final String ELADAS_EXPORTKARTON = "eladas_exportkaton";
	public static final String ELADAS_KISKARTON = "eladas_kiskarton";
	public static final String ELADAS_DARAB = "eladas_darab";
