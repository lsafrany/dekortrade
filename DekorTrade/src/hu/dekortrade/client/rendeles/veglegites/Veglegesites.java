package hu.dekortrade.client.rendeles.veglegites;
...
public class Veglegesites {
	...
	public Canvas process(VevoKosarSer result) {
		...
		if (result == null) {
			...
			middleLayout
					.addMember(kosarCikk.get(result.getCedula(),
							UserInfo.userId, result.getVevo(),
							result.getVevonev(), result.getVevotipus(),
							Constants.MENU_RENDELES_VEGLEGESITES));
		}
