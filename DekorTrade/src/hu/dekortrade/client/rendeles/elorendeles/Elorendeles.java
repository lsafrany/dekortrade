package hu.dekortrade.client.rendeles.elorendeles;
...
import hu.dekortrade.client.kosarcikk.KosarCikk;
	...
	public Canvas process(VevoKosarSer result) {
		...
		if (result == null) {
			...
			middleLayout.addMember(vevo
					.get(Constants.MENU_RENDELES_ELORENDELES));
		} else {
			KosarCikk kosarCikk = new KosarCikk();
			middleLayout
					.addMember(kosarCikk.get("", UserInfo.userId,
