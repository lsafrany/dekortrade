...
public class FelhasznaloDataSource extends GwtRpcDataSource {
	...
	private static void copyValues(FelhasznaloSer from, ListGridRecord to) {
		to.setAttribute(SystemConstants.FELHASZNALO_ROVIDNEV,
				from.getRovidnev());
		to.setAttribute(SystemConstants.FELHASZNALO_NEV, from.getNev());
		to.setAttribute(SystemConstants.FELHASZNALO_MENU, from.getMenu());
	}
	...
	private static void copyValues(ListGridRecord from, FelhasznaloSer to) {
		...
		to.setNev(from.getAttributeAsString(SystemConstants.FELHASZNALO_NEV));
		to.setMenu(from.getAttributeAsString(SystemConstants.FELHASZNALO_MENU));
	}
