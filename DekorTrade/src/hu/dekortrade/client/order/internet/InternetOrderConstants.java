...
public class InternetOrderConstants {

	public static final String INTERNETRENDELT_ROVIDNEV = "internetrendelt_rovidnev";
	public static final String INTERNETRENDELT_RENDELES = "internetrendelt_rendeles";
	public static final String INTERNETRENDELT_DATUM = "internetrendelt_datum";
	public static final String INTERNETRENDELT_STATUSZ = "internetrendelt_statusz";
