...
public class VevoDataSource extends GwtRpcDataSource {
	...
	public VevoDataSource() {
		...
		field = new DataSourceFloatField(
				VevoConstants.VEVO_AJANLOTTARKEDVEZMENY,
	...
	private static void copyValues(VevoSer from, ListGridRecord to) {
		...
		to.setAttribute(VevoConstants.VEVO_BANKSZAMLASZAM,
				from.getBankszamlaszam());
		to.setAttribute(VevoConstants.VEVO_EUADOSZAM, from.getEuadoszam());
		to.setAttribute(VevoConstants.VEVO_ELORARKEDVEZMENY,
				from.getElorarkedvezmeny());
		to.setAttribute(VevoConstants.VEVO_AJANLOTTARKEDVEZMENY,
				from.getAjanlottarkedvezmeny());
	...
	private static void copyValues(ListGridRecord from, VevoSer to) {
		...
		to.setEloleg(from.getAttributeAsFloat(VevoConstants.VEVO_ELOLEG));
		...
		to.setOrszag(from.getAttributeAsString(VevoConstants.VEVO_ORSZAG));
