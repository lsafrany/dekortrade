...
public class KepDataSource extends GwtRpcDataSource {
	...
	private CikktorzsLabels ctozsLabels = GWT.create(CikktorzsLabels.class);
	...
	public KepDataSource() {
		...
		field = new DataSourceTextField(CikktorzsConstants.KEP_SORSZAM,
				ctozsLabels.kepsorszam());
		field.setPrimaryKey(true);
		field.setHidden(true);
		addField(field);

		field = new DataSourceImageField(CikktorzsConstants.KEP_KEP,
				ctozsLabels.kep());
		addField(field);
	...
	protected void executeFetch(final String requestId,
		...
		szinkod = request.getAttributeAsString(CikktorzsConstants.CIKK_SZINKOD);
	...
	protected void executeRemove(final String requestId,
		...
		sorszam = request.getAttributeAsString(CikktorzsConstants.KEP_SORSZAM);
	...
	private static void copyValues(String cikkszam, String from,
			ListGridRecord to) {
		to.setAttribute(CikktorzsConstants.KEP_SORSZAM, from);
		to.setAttribute(CikktorzsConstants.KEP_KEP, GWT.getModuleBaseURL()
